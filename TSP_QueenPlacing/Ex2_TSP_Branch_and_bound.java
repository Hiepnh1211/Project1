...
class Ex2_TSP_Branch_and_bound 
{ 
...
//    static int N ; 
    ...
    static int final_path[] = new int[100]; 
    ...
    // the final solution 
    static void copyToFinal(int curr_path[], int N) 
    { 
        for (int i = 0; i < N; i++) 
    ...
    { 
        ...
        System.out.printf("Minimum length : %d", final_res); 
        System.out.printf("\nPath Taken : "); 
        for (int i = 0; i <= N; i++)  
        { 
